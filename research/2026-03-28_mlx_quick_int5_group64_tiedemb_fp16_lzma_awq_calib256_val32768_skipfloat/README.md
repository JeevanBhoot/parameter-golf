# 2026-03-28_mlx_quick_int5_group64_tiedemb_fp16_lzma_awq_calib256_val32768_skipfloat

AWQ-style activation-aware column scaling on top of the current INT5 group-of-64 + fp16 tied-head + lzma frontier.

- Body quantization: INT5 grouped by 64 columns
- Tied embedding/output head: fp16 passthrough
- AWQ calibration: 256 deterministic train-prefix sequences
