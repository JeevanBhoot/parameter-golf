# 2026-03-29_mlx_quick_int5_group64_headint8_lzma_awqheadonly_calib128_val32768_skipfloat

Structural head-only AWQ follow-up to the INT5 + group64 + INT8 tied-head + lzma frontier.
